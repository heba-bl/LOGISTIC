              ...
              {trace.initialLoading ? (
                ...
                <div className="space-y-5 p-5">
                  ...
                  <section className="grid grid-cols-2 gap-3">
                    <Detail label="Part" value={trace.data.lot.part.reference} mono />
                    <Detail label="Designation" value={trace.data.lot.part.designation} />
                    <Detail label="Supplier" value={trace.data.lot.supplier.name} />
                    <Detail
                      label="Location"
                        ...
                        return (
                          <li key={event.id} className="relative flex gap-3 pb-4 last:pb-0">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="mt-1 flex flex-wrap items-center gap-2 text-[10px] text-ink-3/80">
